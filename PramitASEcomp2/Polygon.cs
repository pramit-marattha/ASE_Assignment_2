...
namespace PramitASEcomp2
{
    ...
    /// <summary>
    /// Polygon class implements the "shape" interface
    /// </summary>
    class Polygon :ShapeInterface
    {
        ...
        int texturestyle;
        Brush bb;
        public void drawShape(string[] inputpoint, Graphics g, int k, int l)
        {
            Pen p = new Pen(c1, 5);
        ...
        public void drawShape(int texturestyle, Brush bb, Color c1, params int[] list)
        {
